...
#Preview {
   ...
   NavigationStack {
      MenuView(
         vm: MenuViewModel(game: GameManager(game: DummyData.game0,cardManager: CardManager(context: ModelContext(try! ModelContainer(for: Card.self))) ), router: GameRouter())
      )
   }
}
